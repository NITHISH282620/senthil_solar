...
npx --yes supabase@latest db execute --linked --file scripts/verify-deploy.sql
...
== Database done. Four things remain that no script can do:
   ...
   130 BLOCKED / 9 ALLOWED / 0 violations:
     npx supabase db execute --linked --file supabase/tests/authz_attacks.sql
     npx supabase db execute --linked --file supabase/tests/integrity.sql
